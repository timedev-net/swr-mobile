...
const styles = StyleSheet.create({
  ...
  card: { width: 180, height: 90, backgroundColor: '#fff', justifyContent: 'center', alignItems: 'center', margin: 5, padding: 10 },
  titulo: { textAlign: 'center', fontSize: 16, color: '#365025' },
  titulo2: { textAlign: 'center', fontSize: 22, color: '#365025' }
})

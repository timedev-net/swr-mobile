...
function DenunciaScreen({ navigation }) {
    ...
    return (
      <>
        <Appbar.Header>
          ...
          <Appbar.Content title="Denúncia" subtitle="SIPE - Sistema de Informação Penitenciária"/>
         ...
         <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Text style={{ color: colors.text }}>Esta é a tela de Denuncia</Text>
